<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 092" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 092｜دفتر الرسم الخطي التعبيري

### يعيد تركيب توتر الصورة بالأبيض والأسود عبر محيط حر وتهشير هندسي
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 092 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

تمحو الخطوط المتجهية النظيفة أثر الإيماءة، بينما يطغى الرسم الواقعي على المساحات السالبة والتكوين؛ يعيد 092 تنظيم العلاقات الغرافيكية في الصورة بخطوط محيط مرتخية وأنواع متعددة من التهشير بعد اختزال مدروس.

يحفظ **Panel 092** هوية الموضوع عبر contour line drawing مرتخٍ ودقيق، ثم يشكّل الظلال والتحولات البنيوية باستخدام diagonal hatching وcross-hatching وscribble hatching. تصف المنحنيات الحرة الأشخاص والحيوانات والنباتات والأشياء، بينما تنظّم مجموعات الخطوط المائلة والهندسة الخطية أسطح الطاولات والجدران والأرضيات والأثاث واتجاهات الظلال، في توتر بين العفوية والهيكل المستقر.

### مناسب لـ

- بناء قوة غرافيكية واضحة بالأبيض والأسود، حيث تصنع كتل التهشير الداكنة والمساحات السالبة الواسعة تراتبية المشهد؛
- إظهار سرعة الملاحظة والإيماءة عبر خطوط سريعة وحرة وخشنة قليلاً وتصحيحات متكررة وكثافة غير متجانسة؛
- خلق توتر بين العفوية والنظام، فتتولى الخطوط الحرة الموضوعات العضوية ويثبّت التهشير الهندسي هيكل البيئة والتكوين؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 092 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** حبر تعبيري · محيط حر · تهشير هندسي · تهشير خربشي · تكوين الفراغ السلبي · كثافة أبيض وأسود
...
|---|---|
| **الناتج** | رسم تعبيري بالحبر يجمع سرعة الملاحظة والقوة الغرافيكية بالأبيض والأسود والتكوين التحريري |
| **البصمة الواضحة** | محيط مرتخٍ، وتهشير مائل ومتقاطع وخربشي، وكتل داكنة، ومساحات سالبة واسعة |
| **احترام المصدر** | يحفظ الهوية الأساسية ومنطق المشهد، ويختزل الخلفية المعقدة بوضوح، ثم يعيد تنظيم الموضع والكثافة والإيقاع |
...
```text
تحليل الموضوع والمحيط والبنية والوضعية والعلاقات السردية → الإبقاء فقط على الهوية الأساسية ومنطق المشهد → بناء الهيئة بمحيط حر مرتخٍ ودقيق → تنظيم الظلال والتحولات البنيوية بتهشير مائل ومتقاطع وخربشي → استخدام المنحنيات الحرة للموضوعات العضوية والتهشير الهندسي لهيكل البيئة → موازنة كتل الكثافة الداكنة بمساحات سالبة واسعة → إضافة قدر قليل من النص التحريري المقتصد
```

## سمات النتيجة النهائية

- يهيمن الأسود والرمادي وبياض الورق؛ ويُسمح بقدر بالغ الضآلة من لون مساعد منخفض التشبع، لكن يبقى الرسم الخطي بالحبر وكثافة الأبيض والأسود في المركز.
- تبني diagonal hatching وcross-hatching وscribble hatching الظلال والتحولات البنيوية، ولا يلزم أن تكون الكثافة متجانسة تماماً.
- لا تحتفظ الخلفيات المعقدة إلا بأسطح الطاولات أو الأرضيات أو الحدود أو الإشارات المكانية الضرورية، بحيث تتنفس المساحات البيضاء وإيقاعات التهشير معاً.
- يبقى النص صغيراً وخفيفاً ومقتصداً، ويتوزع طبيعياً على المساحات البيضاء أو الحدود أو البنى الخطية بدلاً من تكوين شريط عنوان أو قائمة معلومات.
- تجنب الرسم الواقعي، وخطوط القصص المصورة السوداء السميكة، والخطوط المتجهية النظيفة، والطابع الكرتوني، والتفاصيل المفرطة، وتأثيرات مرشحات الحاسوب، وجماليات الملصقات القالبية.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-092-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 092. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-092 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-092 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-092 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-092 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-092 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 092 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-092 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-092`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-092-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-092-prompt.zh-CN.md)
...
| **[xxd-panel-092](https://github.com/nevertoday/xxd-panel-092)** | حبر تعبيري · محيط حر · تهشير هندسي · تهشير خربشي · فراغ سلبي · كثافة أبيض وأسود |
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–092) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
