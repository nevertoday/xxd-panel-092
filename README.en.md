<p align="center"><img src="./assets/banner.svg" alt="XXD Panel 092 project banner" width="1200"></p>
...
| **[xxd-panel-092](https://github.com/nevertoday/xxd-panel-092)** | EXPRESSIVE PEN AND INK · LOOSE CONTOUR · GEOMETRIC HATCHING · SCRIBBLE HATCHING · NEGATIVE SPACE · BLACK-WHITE DENSITY |
...
| **Soldiers** | `xxd-panel-NNN` (currently 001–092) | Each numbered Skill executes only its own original brief and aesthetic, completing the individual job assigned by the General. |
