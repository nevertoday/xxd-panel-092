...
作例枠は確保済みです。検証可能な原作リンク、または 092 原文プロンプトに直接照合した追加作例が揃い次第ここで優先表示し、別番号の画像や壊れたプレースホルダーで代用しません。

<!-- xxd-human-intro:start -->
## このスタイルが解決すること

写真の輪郭フィルターは線を複製するだけで、完成しすぎた写実素描は停筆と余白の節度を失います。

**Panel 092** は正確な輪郭で同一性を残し、一本の青鉛筆または青ボールペンの方向排線、交差排線、探り線、筆圧、乾いた粒子で明暗・体積・素材を織ります。識別部だけを細密化し、他は未完成のまま止めます。

### 向いている用途

- 完整な場面ではなく、主役と記憶に残る生活断片を記録したい場合
- 大小、高低、疎密、方向が自然に変化する浮遊式編集レイアウトが必要な場合
- ゆるい線、水彩、色鉛筆、パステル、明るい柔色、成熟した余白を求める場合
...
| 確認したいこと | このスタイルの答え |
|---|---|
| **得られるもの** | 独立出版の旅行スケッチや文化誌のような単色青筆の物語線描 |
| **識別しやすい特徴** | 青い輪郭、方向排線、交差排線、探り線、選択的細密化、大きな自然紙白 |
...
```text
主体・輪郭・姿勢・関係を分析 → 概念中心を定める → 動作・方向・空間・感情・関係・比喩を分解 → 文字・ノード・軌跡・領域・矢印で意味系を構築 → 三角・折線・交差軸・放射線を組む → 等高線・場線・波形・方向マークを加える → 大きな余白で視覚記譜を完成する
```

## 完成作の特徴

- 幾何線は明晰・鋭利・抑制的にし、手仕事の痕跡は軽いずれ、断裂、不均一を許す。
- 黒や炭灰を文字と骨格に、原写真由来の1〜3鮮色をノード、軌跡、密度場に使う。
- 文字は読めるまま、回転、反復、重なり、経路配置、部分分解でノードや記譜になる。
- 大きな淡色余白を保ち、規則グリッドで全面を埋めない。
- 思考マップ、標準フロー、ダッシュボード、テック UI、サイバー画面、写実挿絵を避ける。
